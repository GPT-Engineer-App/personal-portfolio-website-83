    ...
    <Container centerContent maxW="container.md" height="100vh" display="flex" flexDirection="column" justifyContent="center" alignItems="center">
      <VStack spacing={8}>
        ...
        <Box textAlign="center">
          ...
          <Text fontSize="md">Hi, I'm John Doe, a passionate Full Stack Developer with over 5 years of experience in building web applications. I love working with JavaScript and its ecosystem, and I'm always eager to learn new technologies and improve my skills. When I'm not coding, you can find me contributing to open source projects or exploring the great outdoors.</Text>
        </Box>
      </VStack>
    </Container>
  );
